...
const navigation = [
  ...
  { name: 'Schedule', href: '/schedule', icon: CalendarIcon },  // 替换 Calendar 为 Schedule
  { name: 'Analytics', href: '/analytics', icon: ChartBarIcon },  // 增加 Analytics
];
