...
function Settings() {
  ...
  const [userData, setUserData] = useState({
    ...
    lastName: '',
    email: '',
    jobTitle: '', // 更新字段为 jobTitle
    organization: 'Auckland University of Technology', // 更新字段为 organization
    country: 'New Zealand',
    phoneNumber: '',
  });

  const [profilePicture, setProfilePicture] = useState(null);
  const [previewImage, setPreviewImage] = useState("https://australiancentre.com.br/wp-content/uploads/2017/02/AUT-logo-block-international-white.jpg");
      ...
      try {
        ...
        if (profileResponse.data) {
          setUserData({
            ...
            jobTitle: profileResponse.data.jobTitle || '', // 确保使用正确的字段名称
            organization: profileResponse.data.organization || 'Auckland University of Technology', // 确保使用正确的字段名称
          ...
          setPreviewImage("https://australiancentre.com.br/wp-content/uploads/2017/02/AUT-logo-block-international-white.jpg");
        }
      } catch (error) {
